package com.trkj.trainingprojects.filter;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if(!StringUtils.isEmpty(jwtToken)){
            ...
            if(username != null &&
                ...
                EmpVo empVo = myUserDetailsService.loadUserByUsername(username);
                if(jwtTokenUtil.validateToken(jwtToken,empVo.getUsername())){
                    //给使用该JWT令牌的用户进行授权
                    UsernamePasswordAuthenticationToken authenticationToken
                            = new UsernamePasswordAuthenticationToken(empVo,null,empVo.getAuthorities());
