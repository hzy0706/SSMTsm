...
import com.trkj.trainingprojects.TestService.MyUserDetailsService;
import com.trkj.trainingprojects.filter.JwtAuthenticationTokenFilter;
import com.trkj.trainingprojects.handle.UserAuthAccessDeniedHandler;
import com.trkj.trainingprojects.handle.UserAuthenticationEntryPointHandler;
import com.trkj.trainingprojects.handle.UserLogoutSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .cors()
                .and()
                /*.formLogin().loginPage("/Login.jsp").and()   username password 前后端不分离时配置默认登录界面*/
