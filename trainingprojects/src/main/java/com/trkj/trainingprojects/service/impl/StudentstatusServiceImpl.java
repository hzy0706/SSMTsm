...
public class StudentstatusServiceImpl implements StudentstatusService {
    ...
    @Override
    public List<StudentstatusVo> selectStudentAllotType() {
        return studentstatusDao.selectStudentAllotType();
    }
    ...
    @Override
    public int selectStudentStateByStudentIdAndCouresId(int a,int b) {
        return studentstatusDao.selectStudentStateByStudentIdAndCouresId(a, b);
    }
}
